...
const AboutUsTextArea = ({setSelectedPage}: Props) => {
  return (
    <C.AboutUsTextSection>
          <C.AboutUsContainer>
            <C.LeftSideImgArea
              initial="hidden"
              whileInView="visible"
            ...
            <div className="custom-shape-divider-bottom-1681600646">
